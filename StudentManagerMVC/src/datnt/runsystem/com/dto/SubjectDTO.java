...
public class SubjectDTO {
	...
	public SubjectDTO(String idSubject, String nameSubject, String year, int semester) {
	...
	public SubjectDTO(String idSubject, String nameSubject, String year, int semester, float qtScores, float thScores,
